...
public class MyMain {
	public static void main(String[] args) throws Exception {
		...
		program.sourceFilesDirectory = "dataset/kheapsort/src"; //"grade001/src/main";//"digit003/src/main"; //"syl002/src/main";//
		program.sourceClassFilesDirectory = "dataset/kheapsort/bin"; //"grade001/bin";//"syl002/bin";//
//		program.testFilesDirectory = "dataset/shortest_path_length/src"; //"grade001/src/test";//"syl002/src/test";//
		program.testClassFilesDirectory = "dataset/kheapsort/test"; //"grade001/test";//"syl002/test";//
